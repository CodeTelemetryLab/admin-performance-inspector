 ...
 * Author URI:        https://codetelemetrylab.com
 * License:           GPL-2.0+
 ...
 */
function admin_performance_inspector_activate() {
 ...
 */
function admin_performance_inspector_deactivate() {
...
register_activation_hook( __FILE__, 'admin_performance_inspector_activate' );
register_deactivation_hook( __FILE__, 'admin_performance_inspector_deactivate' );
 ...
 * @since    1.0.0
 */
function admin_performance_inspector_run() {

	$plugin = new Admin_Performance_Inspector();
	$plugin->run();

}
admin_performance_inspector_run();
